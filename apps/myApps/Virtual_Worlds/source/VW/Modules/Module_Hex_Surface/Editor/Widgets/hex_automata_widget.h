...
public:
	...
	// ++++++
	std::vector<hex_surface_automata_rule_struct_type>* hex_surface_automata_rules;// ***** this had to be defined as a pointer so as to be able to change the rules of a voxel automata node
