...
void hex_surface_generation_widget_class::display() {
	...
	void hex_surface_generation_widget_class::perform_decrement_variables(float frame_interval) {
//printf("perform_decrement_variables button clicked\n");// replace with decrement step
	...
	void hex_surface_generation_widget_class::perform_increment_variables(float frame_interval) {
...
//test_hex_hexagon_cell_coord_from_cartesian(hex_surface_object_to_execute->hex_surface_object_data); // ***********
		...
		//hex_surface_object_to_execute->set_value_range(MIN_HEX_SURF_VALUE, MAX_HEX_SURF_VALUE);// This is to be changed to a user defined input in a future update Need to implement this ????
