...
//std::cout << "hex_surface_render_class::define_initial_shader_program :: 1111 \n";
		...
		shader_material->geometry_shader_file_pathname		   = (default_shader_file_directory + hex_surface_default_geometry_file).c_str();
		shader_material->default_geometry_shader_file_pathname = (default_shader_file_directory + hex_surface_default_geometry_file).c_str();
