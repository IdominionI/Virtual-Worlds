...
void cart_to_voxel_generation_widget_class::display() {
	...
	if (float_min_max_slider("v", x_pos, y_pos, 200.0f, min_vscale, max_vscale, voxel_scale_value, 50.0f)) {
		cart_to_voxel_widget.voxel_scale_value = voxel_scale_value;
		update_voxel_size();
	}
...
void cart_to_voxel_generation_widget_class::update_voxel_size() {
	if (voxel_hcp_object_to_execute != NULL) {
//printf("cart_to_voxel_generation_widget_class :: update_voxel_size 000 : %i : %i\n", display_as_points, scene_voxel_object->scene_graph_object.scene_object_class.shader_material->use_point_shader);
...
//-------------------------------------
void cart_to_voxel_generation_widget_class::display_voxel_generation_widget(voxel_hcp_object_class* voxel_hcp_object_to_execute, id_type current_selected_object_id) {
