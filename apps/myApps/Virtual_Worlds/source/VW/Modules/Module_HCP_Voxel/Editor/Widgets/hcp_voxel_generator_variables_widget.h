...
//printf("current_selected_var_id : %i\n", current_selected_var_id);
				//if (ImGui::BeginPopupContextWindow("gr1", 1, true)) { // Old Imgui version
				if (ImGui::BeginPopupContextWindow("gr1", 1)) {
				...
				if (current_selected_var_type_id > -1 && current_selected_var_id < 0)
					//if (ImGui::BeginPopupContextWindow("gr2", 1, true)) {Old Imgui version
					if (ImGui::BeginPopupContextWindow("gr2", 1)) {
