...
public:
	...
	std::vector<voxel_hcp_automata_byte_rule_struct_type> *voxel_hcp_automata_byte_rules;// ***** this had to be defined as a pointer so as to be able to change the rules of a voxel automata node
