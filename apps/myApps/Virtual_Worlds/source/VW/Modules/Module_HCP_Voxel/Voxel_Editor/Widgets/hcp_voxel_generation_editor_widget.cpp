...
#include "../../Object/voxel_hcp_object.h"
	...
	void hcp_voxel_generation_editor_widget_class::display() {
		...
		text("HCP Voxel Editor Generation", x_pos+60, y_pos);
...
//printf("hcp_voxel_generation_editor_widget_class :: change_voxels_display 000 : %i : %i\n", display_as_points, voxel_hcp_object_to_execute->voxel_object_data.shader_parameters.use_point_shader);
	...
	void hcp_voxel_generation_editor_widget_class::update_voxel_size() {
		if (voxel_hcp_object_to_execute != NULL) {
//printf("hcp_voxel_generation_editor_widget_class :: update_voxel_size 000 : %i : %i\n", display_as_points, scene_voxel_object->scene_graph_object.scene_object_class.shader_material->use_point_shader);
...
//-------------------------------------
	void hcp_voxel_generation_editor_widget_class::display_voxel_generation_widget(voxel_hcp_object_class *voxel_hcp_object_to_execute, id_type current_selected_object_id) {
