...
std::cout << "voxel_function_import_export_class: read_cart_to_voxel_parameter_data 1111 : " << line_number << ":" << lines[line_number] << std::endl;
        ...
        line_number++;
        //generator_parameters.display_as_points = stoi(lines[line_number]);line_number++;
        //generator_parameters.voxel_scale       = stof(lines[line_number]);line_number++;
        //generator_parameters.min_scale_value   = stof(lines[line_number]);line_number++;
        //generator_parameters.max_scale_value   = stof(lines[line_number]);line_number++;
