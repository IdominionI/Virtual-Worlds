...
//std::cout << "hcp_voxel_node_class :: define_node 222  : " << std::endl;
    ...
    node_draw_data.node_header_color          = ImColor(0, 139, 139, 255);
    node_draw_data.node_header_hovered_color  = ImColor(0, 175, 175, 255);
    node_draw_data.node_header_selected_color = ImColor(0, 255, 255, 255);
