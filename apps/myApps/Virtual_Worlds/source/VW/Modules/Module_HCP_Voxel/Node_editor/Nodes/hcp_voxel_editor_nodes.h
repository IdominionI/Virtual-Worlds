...
//printf("hcp_voxel_editor_node_class::create_editor_node:: 00000\n");
        ...
        if (graph->node_exists(globalc::get_current_selected_entity_id(), globalc::get_current_selected_entity_type_id(), globalc::get_current_selected_entity_category_id()) {
        //if (graph->node_exists(globalc::get_current_selected_entity_id(), ENTITY_TYPE_OBJECT, globalc::get_current_selected_entity_category_id()) {
