...
//#include "ImNe_menus.h"
#include "Node_Editors/Scene_Node_Editor/scene_node_editor_menus.h"
#include "Node_Editors/node_editor_category_manager.h"

#include "Nodes/Objects/geometry_node.h"
...
public:
    ...
    object_node_editor_menu_class object_node_editor_menu;

    node_type_struct                editor_node_definition;

    scene_node_editor_function_enum scene_node_editor_function_to_execute;
	...
	void setup(){
        ...
        // ******* Define and initialise editor category manager **********
        object_node_editor_category_manager = new node_editor_category_manager_class;
        
        object_node_editor_category_manager->add_editor_node_category(ENTITY_NODE_CATEGORY_GEOMETRY);
        object_node_editor_category_manager->add_editor_node_category(ENTITY_NODE_CATEGORY_LIGHT);
        object_node_editor_category_manager->add_editor_node_category(ENTITY_NODE_CATEGORY_MATERIAL);

        // *************************************************

        // Define node editor nodes
        ...
        //objedct_node_editor_category_manager->add_editor_node();
...
//std::cout << "display() 0003" << std::endl;
                ...
                scene_node_editor_function_to_execute = scene_node_editor_function_enum::none;

                object_node_editor_menu.define_imgui_menu(editor_node_definition,scene_node_editor_function_to_execute, "Object ", true);
...
//std::cout << "display() 0003BB" << std::endl;
                ...
                if (scene_node_editor_function_to_execute != scene_node_editor_function_enum::none) {
                    switch (scene_node_editor_function_to_execute) {
                        case scene_node_editor_function_enum::create_object_node :{
                            create_node(editor_node_definition, click_pos);
                            break;
                        }
                    }
                }
...
//printf("scene_node_editor_class::create_entity_node 22222\n");
    ...
    void create_node(node_type_struct editor_node_definition, ImVec2 click_pos) {

std::cout << "create_node 000 :: " << editor_node_definition.node_type << std::endl;
        object_node_editor_category_manager->perform_editor_node_creation(editor_node_definition, &graph, click_pos);
       // node_editor_category_manager->perform_editor_node_creation(editor_node_definition, &graph, scene_manager, log_panel, click_pos);

        //geometry_node = new geometry_node_class;
        //geometry_node->entity_id = 1;
        //geometry_node->label = "geo001";
        //graph.add_node(geometry_node, click_pos, 1);

std::cout << "create_node 001" << std::endl;
    }
    ...
    void handle_new_links() {
        ...
        if (ImNodes::IsLinkCreated(&start_attr, &end_attr))
        {
            ...
            if (start_pin.data_type == end_pin.data_type && start_pin.context == end_pin.context)
            {
    ...
    node_editor_category_manager_class *object_node_editor_category_manager;
    ...
    geometry_node_class *geometry_node;

private:

    imgui_menu_manager_class menu_manager;
